...
public class Main extends JavaPlugin {
	...
	//Reads the config for arenas and loads them in the arenas ArrayList as an Arena object
	...
	public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
		//Uses an enhanced for loop to go through an arraylist and check if the name
		//matches the command label then calls the "called" method
		//If you dont know what an enhanced for loop it runs one time for every object
		//in the commads arraylist and sets command equal to the object that its on
